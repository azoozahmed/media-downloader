...
public class YoutubeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.youtube_fragment,null);
        thiscontext = container.getContext();

       getDownload =v.findViewById(R.id.getDownloadBtnYoutube);
        link = v.findViewById(R.id.linkTextYoutube);
       downloadBtn = v.findViewById(R.id.downloadBtnYoutube);
        downloadBtn.setVisibility(View.GONE);
        youtubeIcon1=v.findViewById(R.id.youtubeIcon1);
        prograss=v.findViewById(R.id.progress_circular_youtube);
        cancelLink = v.findViewById(R.id.cancelLink);
        progressText = v.findViewById(R.id.progressText);

        //**********Check arabic language***************
        if (Locale.getDefault().getLanguage().equals("ar")){
            RelativeLayout youtubeLayout = v.findViewById(R.id.youtubeLayout);
        ...
        if(isDownloading){
            ...
            youtubeIcon1.setVisibility(View.GONE);
            ...
            if(prograss.getVisibility() == View.GONE) {
                ...
                Disposable disposable = Observable.fromCallable(() -> YoutubeDL.getInstance().execute(request, String.valueOf(callback)))
                        ...
                        .subscribe(youtubeDLResponse -> {
                            ...
                            downloadBtn.setVisibility(View.GONE);
                            link.setText(null);
                            youtubeIcon1.setVisibility(View.VISIBLE);
                            isDownloading = false;
                           isLoadingLate = false;
                        }, e -> {
