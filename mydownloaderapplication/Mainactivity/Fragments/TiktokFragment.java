...
public class TiktokFragment extends Fragment {
    ...
    public boolean isLoadingLate = false;
    ...
    private final DownloadProgressCallback callback = new DownloadProgressCallback() {
        ...
        public void onProgressUpdate(float v, long l, @Nullable String s) {
            ...
            progressText.setText(String.valueOf(l));
        }
    };
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.tiktok_fragment,null);

        progressText = v.findViewById(R.id.progressText);
        progressBar = v.findViewById(R.id.prgbarTiktok);
        getDownloadBtn = v.findViewById(R.id.getDownloadBtnTiktok);
        downloadBtn = v.findViewById(R.id.downloadBtnTiktok);
        tiktokIcon1 = v.findViewById(R.id.tiktokIcon1);
        link= v.findViewById(R.id.linkTextTiktok);
        prograss=v.findViewById(R.id.progress_circular_tiktok);
        cancelLink = v.findViewById(R.id.cancelLink);
        //**********Check arabic language***************
        if (Locale.getDefault().getLanguage().equals("ar")){
            @SuppressLint({"MissingInflatedId", "LocalSuppress"}) RelativeLayout tiktokLayout = v.findViewById(R.id.tiktokLayout);
            tiktokLayout.setRotationY(180);
        }
        //*******************************************
        ...
        if(isDownloading){
            ...
            tiktokIcon1.setVisibility(View.GONE);
...
//ca-app-pub-5745492974183360/1006105424
      ...
      */
        ...
        cancelLink.setOnClickListener(v1 -> {
            link.setText(null);
            cancelLink.setVisibility(View.GONE);
        });
        //*********** get shared link
        ...
        getDownloadBtn.setOnClickListener(v12 -> {
            //*****check connection ************
        ...
        downloadBtn.setOnClickListener(v13 -> {
            if (prograss.getVisibility() == View.GONE) {
                prograss.setVisibility(View.VISIBLE);
                isDownloading = true;
                ...
                Disposable disposable = Observable.fromCallable(() -> YoutubeDL.getInstance().execute(request, String.valueOf(callback)))
                        ...
                        .subscribe(youtubeDLResponse -> {
                            ...
                            link.setText(null);
                            tiktokIcon1.setVisibility(View.VISIBLE);
                            isDownloading = false;
                            isLoadingLate = false;
                        }, e -> {
