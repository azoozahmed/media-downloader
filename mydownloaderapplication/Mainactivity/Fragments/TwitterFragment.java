...
public class TwitterFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.twitter_fragment,null);

        link= v.findViewById(R.id.linkTextTwitter);
        cancelLink = v.findViewById(R.id.cancelLink);
        getDownloadBtn =v.findViewById(R.id.getDownloadBtnTwitter);
        link = v.findViewById(R.id.linkTextTwitter);
        downloadBtn = v.findViewById(R.id.downloadBtnTwitter);
        downloadBtn.setVisibility(View.GONE);
        twitterIcon1=v.findViewById(R.id.twitterIcon1);
        prograss=v.findViewById(R.id.progress_circular_twitter);

        //**********Check arabic language***************
        if (Locale.getDefault().getLanguage().equals("ar")){
            @SuppressLint({"MissingInflatedId", "LocalSuppress"}) RelativeLayout twitterLayout = v.findViewById(R.id.twitterLayout);
            twitterLayout.setRotationY(180);
        }
        ...
        if(isDownloading){
            ...
            twitterIcon1.setVisibility(View.GONE);
...
//ca-app-pub-5745492974183360/1006105424
            ...
            if (prograss.getVisibility() == View.GONE) {
                ...
                Disposable disposable = Observable.fromCallable(() -> YoutubeDL.getInstance().execute(request, String.valueOf(callback)))
                        ...
                        .subscribe(youtubeDLResponse -> {
                            ...
                            downloadBtn.setVisibility(View.GONE);
                            link.setText(null);
                            twitterIcon1.setVisibility(View.VISIBLE);
                            isDownloading = false;
                            isLoadingLate = false;
                        }, e -> {
    ...
    void handleSendText(Intent intent) {
        ...
        if (sharedText != null) {
            if (sharedText.contains("twitter")) {
